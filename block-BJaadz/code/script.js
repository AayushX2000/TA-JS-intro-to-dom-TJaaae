...
// Set the border of the all the hr elements to "1px solid tomato"
  allHrsArray.forEach((ele)=>{
    console.log(ele.style.border="1px solid tomato")
  })
// Change the background of all the hr to "antiquewhite" using for of loop.
allHrsArray.forEach((ele)=>{
  console.log(ele.style.backgroundColor="antiquewhite")
})
// Change the 'border-radius' of all the hr to "5px" using array.
allHrsArray.forEach((ele)=>{
  console.log(ele.style.borderRadius="5px")
})
...
allHrsArray.forEach((ele)=>{
  console.log(ele.style.borderStyle="1px dashed green")
})
// Create a pragraph element and store it in variable named 'para' using `createElemen
...
let box1 =document.body.getElementsByClassName("box one");
box1.remove();

// Replace all the elements inside box 1 with the para (you created above)
document.querySelector('.box1').replaceWith(para);
/* Walking the DOM
...
*/
  ...
  let box16=document.getElementsByClassName("box sixteen")
  console.log(box16[0]);
...
let box2=document.getElementsByClassName("box two");
console.log(box2[0]);
...
let box3=document.getElementsByClassName("box three");
console.log(box3[0]);
let thirdPara=document.createElement('p');
thirdPara.innerText=" Prepend inserts as first child" 
box3.prepend(thirdPara);

// Change the border of box 4 to '1px solid black'
let box4=document.querySelector(".box four").style.border="1px solid black"


// Change the border radius of box 5 to 10px.
let box5=document.getElementsByClassName("box five").style.borderRadius="10 px"


// Change the text color of box 6 to black.
let box6=
document.body.querySelector(".box six")
box6.style.color="Black"

// Change the font size of the para inside box 1 to 0.8rem.
document.body.getElementsByClassName("box one").style.fontSize="0.8rem"
...
// textContent of the btn should be 'Click Me'
...
document.querySelector(".box nine").append(btn)
...
let engine=document.createElement("a")
...
engine.href=`https://google.com`
// Append both the elements to box 5 you selected above.
five.append(brand,engine)
