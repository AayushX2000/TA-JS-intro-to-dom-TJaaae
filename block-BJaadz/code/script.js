...
let box1 =document.body.querySelector(".one");
box1.innerHTML=""
...
let box5=document.querySelector(".five").style.borderRadius="10 px"


// Change the text color of box 6 to black.
let box6=
document.body.querySelector(".six")
...
// add a class named "awesome-box" to the box 6 using classList property of DOM element.
  document.querySelector('.six').className="awesome-box"
// Using the toggle classList property toggle the class `awesome-box` from box 2
document.querySelector('. Gtwo').classList.toggle="awesome-box"
